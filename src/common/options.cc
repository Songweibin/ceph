...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    Option("objecter_pause_op_on_mon_lost", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    ...
    Option("osd_async_recovery", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    ...
    Option("osd_force_recovery_op_priority", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(64)
...
static std::vector<Option> get_rbd_options() {
  return std::vector<Option>({
    ...
    Option("rbd_invalidate_object_map_on_load_timeout", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(true)
    .set_description("true if object map should be invalidated when load timeout"),
